...
void init_tile_properties(void) {
    ...
    tile_properties[243] = TERRAIN_ROAD;  // Finish line
    tile_properties[244] = TERRAIN_ROAD;  // Finish line
    tile_properties[245] = TERRAIN_ROAD;  // Finish line
    tile_properties[246] = TERRAIN_ROAD;  // Finish line
    tile_properties[247] = TERRAIN_ROAD;  // Finish line
    tile_properties[248] = TERRAIN_ROAD;  // Finish line
}
